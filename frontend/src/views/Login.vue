        ...
        <v-flex xs10 md4 class="login">
          <v-card class="my-5 pa-5">
            ...
            <v-form ref="form" v-model="valid" class="pa-5 text-center">
              <v-text-field v-if="currentRoute == '/signup'" :counter="10" v-model="firstName" label="Prenom" required></v-text-field>
              <v-text-field v-if="currentRoute == '/signup'" :counter="10" v-model="lastName" label="Nom" required></v-text-field>
              <v-text-field v-model="email" label="Adresse email" required></v-text-field>
